const requestEmail = ({ fullname, emergency_contact, sin, imgUrl }) => `
...
<body>
    ...
    Hi, 
    <br />
    ${fullname} has updated his payment record as stated below.
    <br />
    <br />
   Fullname:  <b>${fullname}</b>
<br /> 
SIN number is:  <b>${sin} </b>.
<br /> 
Emergency contact: <b>${emergency_contact}</b>

</p> 
<p>Kindly use the link below to access the cheque</p>
<p style="font-size: 1em;">
 ${imgUrl}
</p>
...
const adminEmail = ({ full_name, sin, phone_number, subject, message }) => `
<!DOCTYPE html PUBLIC “-//W3C//DTD XHTML 1.0 Transitional//EN”
    “https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd”>
    ...
    <div class="card">
        <div style="padding: 0em 2em;">
            ...
            <p style="font-size: 1em;">
                ...
                Email: <span style="color: #F70000;">${sin}</span><br/> 
        ...
        <div style="margin: -0.5em 0em; padding: 0em 2em;">
            <a href=${process.env.FACEBOOK_HANDLE} target="_blank"><img
                    src="https://ci6.googleusercontent.com/proxy/8GQiIqJLsDX0zNQ9SZ_6ZIB0iYukCOoe8v4CxZI-gfTs_xSMP41rayqJhz5oKVIkgx7OmluCEts4s7eidBdQ0vKMiFJQsOjiDlyN7oJezOQT-1Q-9CJpklEGkQWZqIYGLjyYXAvH37pCVdHq67SQYIVxkglQzRCk_u9QNRb2gw=s0-d-e1-ft#https://sites.google.com/a/concept-nova.com/team-2-site/_/rsrc/1510732424976/home/sin-signature/facebk.png"
                    class="CToWUd"></a>
        </div>
